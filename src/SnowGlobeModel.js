    ...
    <>
      ...
      <Billboard>
        <Text
          ...
          lineHeight={0.85}
        >
          Happy New Year! Here’s to 12 months of laughter, adventure, and making
          unforgettable memories! {"\n\n"} Let’s crush it this year like we mean
          it!
        </Text>
        {/* <Text
          maxWidth={2.5}
          ...
          fontSize="0.1"
        >
          Thank you support in 2024. Great things are coming in 2025.
        </Text> */}
        <Text
          maxWidth={1.5}
          textAlign="center"
